...
<body>
    ...
    <div class="container mt-5 mb-4 rounded shadow-sm" style="width:50%;">
      <h1 class="display-4 text-center mb-4">Add new single item</h1>
      <div class="container w-75 mt-4">
        <form metho mt-5d="POST" action="proc/item-single-proc.php" enctype="multipart/form-data">
            <p>Name of Food: <input type="text" name="name" class="form-control w-75" placeholder="Mighty Chicken...." required autofocus> </p> <br>
            <p>Type of Food:</p>
